...
function Flower({flower, onDelete}) {
        ...
        <>
                ...
                <div
                    ...
                    <div className="mt-3 flex flex-row justify-center space-x-3">
                        <button aria-label="Edit" className="bg-[#FF9A9A] border-2 border-solid border-[#945034] p-1"
                                onClick={() => onDelete(flower.id)}><MdEdit />
                        </button>
                        <button aria-label="Details" className="bg-[#FF9A9A] border-2 border-solid border-[#945034] p-1"
                                onClick={() => onDelete(flower.id)}><TbListDetails />
                        </button>
                        <button aria-label="Delete" className="bg-[#FF9A9A] border-2 border-solid border-[#945034] p-1 "
